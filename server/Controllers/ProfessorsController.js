...
//     //*  send credential to professors to login with notification to update there password 
...
const ProfessorResetRequest = async (req, res) => {
  ...
  try {
    ...
    const resetLink = `http://${process.env.FRONTEND_URL}/userPasswordReset/${user.professorId}`
